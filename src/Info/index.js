          ...
          <div className="info__content">
            <div className="info__professional-career">
              ...
              <p className="info__description">Certificamos você no uso da ferramentas de Avaliação de Perfil Comportamental  para atuar de forma mais assertiva e segura em diversas áreas, Treinamento, Desenvolvimento,
                coaching, Recursos Humanos,  Recrutamento e Seleção,   Retenção de Talentos, Aumento de Produtividade, Formação de Liderança,  Gestão de Performance,  Gestão de Competências. <a href="https://api.whatsapp.com/send?phone=5534984311111">Entre em contato para saber mais sobre próxima turma. </a> </p>
            </div>
